...
def get_last_price(ticker: str) -> float:   
  """ 
  Esta funcion busca usando la API de yahoo finance el ultimo precio disponible del 
  instrumento cuyo ticker es 'ticker'.  
  @:param ticker: ticker de la empresa a consultar   
  """ 
  yahoo_finance_url = f"https://query1.finance.yahoo.com/v8/finance/chart/{ticker}" 
  # yahoo_finance_url = "https://query1.finance.yahoo.com/v8/finance/chart/" + ticker  # lo 
mismo que arriba
